/*
 * This code was retreived from http://home.hiwaay.net/~taylorc/toolbox/geography/geoutm.html
 * on 12/17/2012 by pgarceau. At the time of retrevial, the website states:
 * 
 * "Programmers: The JavaScript source code in this document may be copied and reused without restriction."
 * 
 * It has been modified to export functionality as an object name GEOUTM.
 * 
...
GEO.utm = (function() {
	...
	/*
	 * Method: computeUTMLetterDesignator
	 * 
	 */
	function computeUTMLetterDesignator(lat) {
		var letter;
	 ...
	 * Outputs:
	 *   {easting, northing, zone, zoneCode, southhemisphere} -
	 *   		Javascript object with all parameters of utm coordinate
	 *
	 * Returns:
	...
	function LatLonToUTMXY(lat, lon) {
		var xy = [],
			...
			zoneCode = computeUTMLetterDesignator(lat);
	 ...
	 *
	 * Outputs:
	 *	latlon - A javascript objectcontaining the latitude and
	 ...
	 *
	 */
	 function UTMXYToLatLon(easting, northing, zone, southhemi) {
		var cmeridian,
			latlon = {},
			x = easting,
			y = northing;
