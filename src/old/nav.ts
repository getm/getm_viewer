...
export function navSetup() {
    ...
    bannerImg.src = 'images/NGA.png';
    bannerImg.className = 'banner-img navbar-brand';
    navBarHeader.appendChild(bannerImg);

    var headerTxt = document.createElement('a');
    headerTxt.textContent = 'GETM Viewer';
    headerTxt.className = 'header-text navbar-brand';
    navBarHeader.appendChild(headerTxt);
    ...
    //navContainer.appendChild(createSearch());
}

function createSearch() {
    var col = document.createElement('form');
    col.className = 'navbar-form navbar-right';
    ...
    inputGroup.appendChild(searchResults);
